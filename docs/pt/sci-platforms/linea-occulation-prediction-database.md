...
Além disso, o serviço disponibiliza o **pacote Python** ([`lineaSSP`](https://github.com/linea-it/lineassp)) para integração em workflows científicos e um **serviço de subscrição** para notificação de eventos personalizados.
