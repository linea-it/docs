...
Caso não exista, solicite ao *helpdesk@linea.org.br* a criação do diretório do projeto em `/scripts/cl/prj/<sigla>`.
...
| Projeto compartilhado | `/scripts/cl/prj/<sigla>` | ⚠️ sem backup |
