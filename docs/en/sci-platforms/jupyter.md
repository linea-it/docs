...
The standard JupyterHub installation uses the new [JupyterLab](https://jupyterlab.readthedocs.io/en/stable/) interface and is based on the [datascience-notebook](https://github.com/jupyter/docker-stacks) image. This means several popular *Python* libraries such as [Astropy](https://www.astropy.org/), [Numpy](https://numpy.org/), and [Matplotlib](https://matplotlib.org/) will be automatically available.
...
In the [jupyterhub-tutorial](https://github.com/linea-it/jupyterhub-tutorial) repository, you will find tutorials in *notebook* format:
...
Instructions for using the dblinea library to read data from the database directly from a notebook cell, with usage examples (building a simple colour-magnitude diagram for a star sample).
#### 3-conda-env.ipynb
...
To access the *notebooks*, simply open a Terminal in JupyterLab by clicking the "+" button in the top bar and then the "Terminal" icon in the "Other" section of the "Launcher" tab, and enter the command:
...
### Short courses
  ...
  1. Course 1 – The class videos are available on the [Jupyter Notebook Short Course](https://classroom.google.com/c/NDkzMTA0MzEyODA1/m/NDcyNjUyMTg5Mjc1/details) page on Google Classroom. -->

## Computational resources

**Available configurations for Jupyter over K8S**

After logging into the platform, a menu with up to three configuration options will be displayed. Simply select and click *Start My Server*.
